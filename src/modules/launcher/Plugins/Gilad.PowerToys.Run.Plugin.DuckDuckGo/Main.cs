...
using System.Text;
using Gilad.PowerToys.Run.Plugin.DuckDuckGo.UriHelper;
using ManagedCommon;
...
namespace Gilad.PowerToys.Run.Plugin.DuckDuckGo
{
    public class Main : IPlugin, IPluginI18n, IContextMenu, ISavable, IDisposable
    {
        ...
        public Main()
        {
            ...
            _duckDuckGoUriParser = new DuckDuckGoUriParser();
        ...
        public List<Result> Query(Query query)
        {
                ...
                results.Add(new Result
                {
                    ...
                    Action = action =>
                    {
                        if (!Helper.OpenInShell(BrowserPath))
                        {
                            ...
                            var message = $"{Properties.Resources.plugin_failed}: ";
            ...
            if (!string.IsNullOrEmpty(query?.Search)
                && _duckDuckGoUriParser.TryParse(query.Search, out var uriResult)
